    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href='/list-pengemudi'>Data Pengemudi</a></li>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($rides as $history)
                                    <tr>
                                        <td>
                                            {{ $history->passenger->user->name }}
                                        </td>
                                        <td>
                                            <a href="/list-pengemudi/detail/view/{{ $history->id }}" class="btn btn-info"
