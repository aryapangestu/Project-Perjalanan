                                    ...
                                    @if ($user->role == 2)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalview{{ $user->id }}">
                                                    View
                                                </button>
                                                ...
                                                <div class="modal fade" id="modalview{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <h5 class="modal-title" id="exampleModalLabel">Info Pengemudi</h5>
