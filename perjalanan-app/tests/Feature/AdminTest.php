...
class AdminTest extends TestCase
{
    ...
    public function Lihat_list_penumpang()
    {
        $response = $this->get('/list-penumpang');
        $response->assertStatus(200);
    }

    public function Lihat_list_pengemudi()
    {
        $response = $this->get('/list-pengemudi');
        $response->assertStatus(200);
    }

    public function Lihat_detail_di_list_penumpang()
    {
        $response = $this->get('/list-penumpang/detail/1');
        $response->assertStatus(200);
    }

    public function Lihat_detail_di_list_pengemudi()
    {
